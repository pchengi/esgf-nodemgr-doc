...
Strategy 2:  greedy algorithm based on latencies.  Member nodes are assigned to super nodes using lowest latency in a similar greedy algorithm.  The 
